...
//
//@Repository
//public interface DoctorScheduleRepository extends JpaRepository<Schedule, Integer> {
//
...
//    Optional<Schedule> findByDoctor_DoctorIdAndDayOfWeek(Integer doctorId, Integer dayOfWeek);
//
